...
class AddViewController: UIViewController {
    ...
    @IBOutlet var viewTasksBotton: UIButton!
    ...
    @IBAction func viewTasksBtnAction(_ sender: UIButton){
        
        
        let addVc = UIStoryboard.init(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "TasksViewController") as! TasksViewController
...
//        print(lists[0].tasks[0].name)
    ...
    func setToolBar() {
        ...
        let cancelButton = UIBarButtonItem(title: "Cancel", style: UIBarButtonItem.Style.plain, target: self, action: #selector(doneClicked))
